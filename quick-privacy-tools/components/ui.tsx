...
export function ToolShell({
  ...
  return (
    <main className="min-h-screen bg-slate-950 px-6 pt-4 pb-12 text-white">
      <div className="mx-auto max-w-5xl">
        <Link
          href="/"
          className="mb-8 inline-block text-sm font-semibold text-blue-300 hover:text-blue-200"
        >
          ← Back to all tools
        </Link>
