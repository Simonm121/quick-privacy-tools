...
const categories = [["ip-tools", "IP Tools"], ["passwords", "Passwords"], ["privacy", "Privacy"], ["domain", "Domain"]];
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden px-6 py-16 md:py-24">
        ...
        <div className="relative mx-auto max-w-7xl text-center">
          <div className="mx-auto mb-6 inline-flex rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-slate-300">Fast checks. No login. Built for everyday privacy tasks.</div>
          <h1 className="mx-auto max-w-5xl text-4xl font-black tracking-tight md:text-7xl">Privacy tools that run instantly in your browser</h1>
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-300 md:text-xl">Check your IP, test your VPN, generate secure passwords and protect your data — no tracking, no signup, everything runs locally where possible.</p>
      ...
      <section className="px-6 pb-8">
        <div className="mx-auto max-w-7xl rounded-3xl border border-dashed border-white/15 bg-slate-900/80 p-6 text-center text-sm text-slate-400">Ad Banner Placeholder</div>
      </section>
      <section className="px-6 pb-20">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="rounded-3xl border border-dashed border-white/15 bg-slate-900/80 p-6 text-center text-sm text-slate-400">Ad Banner Placeholder</div>
        </div>
      </section>
    </main>
  );
